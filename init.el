...
(defun dotspacemacs/user-config ()
  ...
  (defun spacemacs/ivy-persp-switch-project (arg)
    ...
    (with-eval-after-load 'org-agenda
        ...
        ;;(push ("~/org-notes/TODOs.org") org-agenda-files)
        ;;(push ("~/org-notes/TODOs2.org") org-agenda-files)
        )
    ;;(setq org-agenda-files (list "~/org-notes/gtd.org" "~/.emacs.d/org-files/gtd2.org"))
